...
public enum ExceptionCodeEnum {
    ...
    SYSTEM_TIMEOUT("8008", "系统维护中~请稍后再试~"),
    PARAM_EX("8001", "参数类型解析异常"),
    SQL_EX("8002", "运行SQL出现异常"),
    NULL_POINT_EX("8003", "空指针异常"),
    ILLEGAL_ARGUMENT_EX("8004", "无效参数异常"),
    MEDIA_TYPE_EX("8005", "请求类型异常"),
    LOAD_RESOURCES_ERROR("8006", "加载资源出错"),
    BASE_VALID_PARAM("8007", "统一验证参数异常"),
    OPERATION_EX("8007", "操作异常"),
    SERVICE_MAPPER_ERROR("8007", "Mapper类转换异常"),
    CAPTCHA_ERROR("8007", "验证码校验失败"),
    JSON_PARSE_ERROR("8007", "JSON解析异常"),
    ...
    public ExceptionCodeEnum build(String msg, Object... param) {
        this.msg = String.format(msg, param);
        return this;
    }

    public ExceptionCodeEnum param(Object... param) {
