package com.momo.theta.utils.date;
...
public class LocalDateTimeUtils {
    ...
    public static String currentDayBeginDate(String day) {
        DateTimeFormatter df = DateTimeFormatter.ofPattern(DateFormatEnum.DATE_FORMAT_DATE_ONLY.getCode());
     ...
     * @return true?符合:不符合
     */
    public static boolean checkCycle(LocalDate beginDate, LocalDate endDate, String beginPeriod, String endPeriod,
                                     String cycle) {
        try {
     ...
     * @return true?符合:不符合
     */
    public static boolean checkCycle(LocalDateTime beginDate, LocalDateTime endDate, String beginPeriod,
     ...
     * @return
     */
    private static boolean checkCycleExceptLocalDate(String beginPeriod, String endPeriod, String cycle,
                                                     LocalDate now) {
        // 2.检验时间段范围内
        ...
        LocalTime beginTime = LocalTime.of(Integer.parseInt(beginPeriodTime[0]), Integer.parseInt(beginPeriodTime[1]),
                Integer.parseInt(beginPeriodTime[2]));
        String[] endPeriodTime = endPeriod.split(":");
        LocalTime endTime = LocalTime.of(Integer.parseInt(endPeriodTime[0]), Integer.parseInt(endPeriodTime[1]),
