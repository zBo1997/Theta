 ...
 *         - id: db
 *           type: dbNumberSegment
 *           args: {id: 'paymentOrderSequence', maxSequenceValue: '9999999999', length: '10'}
 *         - id: type
 *           type: fixedStringSegment
 *           args: {segmentString: 'P0'}
 *         - id: databaseIndex
 *           type: hashSegment
 *           args: {length: '2', defaultMod: '2', hashField: 'isvId', defaultValueField: 'databaseDefaultValue'}
 *         - id: tableIndex
 *           type: hashSegment
 *           #type: subStringSegment
 *           args: {length: '3', defaultMod: '128', hashField: 'innerReqMsgId', startField: 'tableStart'}
 *           #args: {length: '3', stringField: 'timestamp', start: '6', end: '8'}
 *         - id: nodeNo
 *           type: fixedStringSegment
 ...
 *           type: randomStringSegment
 *           args: {length: '6'}
 *       - id: settleOrderIdentitySequence
 *         type: compositeString
 *         segmentConfigs:
 *         - id: date
 *           type: dateSegment
