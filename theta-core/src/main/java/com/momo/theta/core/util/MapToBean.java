package com.momo.theta.core.util;
...
public class MapToBean {
    ...
    public static <T> T mapToBean(Map<String, Object> paramMap, Class<T> beanType) throws IntrospectionException {
        if (beanType.isPrimitive() || beanType.isAssignableFrom(Date.class) || beanType.isAssignableFrom(Number.class) || beanType.isEnum()) {
            throw new IllegalStateException("Unsupported beanType '" + beanType + "' for map converting bean");
        }
        ...
        for (String name : paramMap.keySet()) {
            ...
            try {
                ...
                if (logger.isWarnEnabled()) {
                    logger.warn("bean of {} no such property named {},Ensure this beanType is proper use, or the value of input-parameter '{}' is no use", beanType, name, name);
                }
                continue;
            }
            ...
            if (convertException != null) {
                throw new IllegalArgumentException("'" + value + "' error converting " + type, convertException);
