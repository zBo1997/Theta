package com.momo.theta.queue.factory;
...
import com.momo.theta.queue.data.ObjectEventFactory;
...
public class DisruptorQueueFactory {
  ...
  public static <T> StandDisruptorQueue<T> getHandleEventsQueue(int queueSize,
