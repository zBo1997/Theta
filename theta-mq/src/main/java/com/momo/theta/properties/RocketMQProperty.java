...
public class RocketMQProperty {
  ...
  public static class Topic {
    ...
    /**
     * 消费模式 concurrently-并发消费 orderly-顺序消费
     */
    ...
    @Override
    public int hashCode() {
      return Objects.hash(this.enable, this.topicName, this.tag, this.consumerGroup,
          this.listenerType, this.msgHandler, this.consumeThreadMin, this.consumeThreadMax,
          this.consumeMessageBatchMaxSize, this.pullBatchSize);
    }
