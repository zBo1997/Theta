package com.momo.theta.mq.service;

import com.momo.theta.mq.queue.DisruptorQueue;
import com.momo.theta.mq.queue.NormalQueue;
import com.momo.theta.mq.queue.OrderQueue;
...
public class MsgQueue implements AutoCloseable {
    ...
    public boolean publish(MqData data) {
        ...
        if (Objects.isNull(data) || StringUtils.isEmpty(data.getTopic()) || StringUtils.isEmpty(data.getBody())) {
            return false;
        }
